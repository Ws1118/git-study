...
启动命令行，输入：git --version：![image-20200920141656435](C:\Users\dell\AppData\Roaming\Typora\typora-user-images\image-20200920141656435.png)
...
- 查看仓库：`git status`   查看日志：`git log`   本地文件导入GitHub: 
  ...
  ```
   ...
   ![2](C:\Users\dell\AppData\Roaming\Typora\typora-user-images\2.png)
...
本地文件导入GitHub![4](C:\Users\dell\AppData\Roaming\Typora\typora-user-images\4.png)
...
- 本地和远程分支的删除
  ...
  - 删除远程：:`git branch -r -d dev` `git push origin :dev`![5](C:\Users\dell\AppData\Roaming\Typora\typora-user-images\5.png)